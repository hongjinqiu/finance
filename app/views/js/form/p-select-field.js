 ...
 */
Y.PSelectField = Y.Base.create('p-select-field', Y.PChoiceField, [Y.WidgetParent, Y.WidgetChild], {

    FIELD_TEMPLATE : '<select></select>',

    /**
     * @property PSelectField.DEFAULT_OPTION_TEXT
     * @type String
     * @description The display title of the default choice in the select box
     */
    DEFAULT_OPTION_TEXT : '请选择',	
    ...
    _renderFieldNode: function() {
        Y.PSelectField.superclass.constructor.superclass._renderFieldNode.apply(this, arguments);
    ...
    _renderOptionNodes: function() {
        ...
        if (this.get('useDefaultOption') === true) {
            elOption = Y.Node.create(Y.PSelectField.OPTION_TEMPLATE);
    ...
    _syncFieldNode: function() {
        Y.PSelectField.superclass.constructor.superclass._syncFieldNode.apply(this, arguments);
    ...
    bindUI: function() {
        Y.PSelectField.superclass.constructor.superclass.bindUI.apply(this, arguments);
        this.after('choicesChange', this._afterChoicesChange);
    },

    syncUI: function() {
        Y.PSelectField.superclass.syncUI.apply(this, arguments);
        this._syncOptionNodes();
    }
},
{
    /**
	 * @property PSelectField.OPTION_TEMPLATE
	 * @type String
